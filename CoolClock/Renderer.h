...
public:
    ...
    // 背景コンポーネント
    void AddBackground(class BackgroundComponent* bg);
    void RemoveBackground(class BackgroundComponent* bg);
    ...
    void SetDirectionalLight(const Vector3 directional) { dirLight.DiffuseColor = directional; }
...
private:
    ...
    std::vector<class BackgroundComponent*> bgComps;
